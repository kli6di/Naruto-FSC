...
<head>
    ...
    <title>Personnage - Yoné Atta</title>
    <!-- Google Fonts en fallback si Verdana n'est pas disponible -->
...
<body>
    <div class="container" role="main">
        ...
        <section class="section" aria-labelledby="apparence">
